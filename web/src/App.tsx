    ...
    <div className="max-w-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="#" className="relative rounded-lg overflow-hidden">
          ...
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
            ...
            <span className="text-zinc-400 text-sm block">4 Ads</span>
          </div>
        </a>
      ...
      <div className="pt-1 bg-nlw-gradient mt-8 self-stretch rounded-lg">
        <div className="bg-[#2A2634] px-8 py-6 flex justify-between items-center rounded">
          ...
          <button className="flex items-center gap-3 py-3 px-4 font-medium text-white rounded bg-violet-500 hover:bg-violet-600">
